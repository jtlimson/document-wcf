...
namespace document.Library
{
    ...
    {
        private string _remoteUNC;
        private bool disposed = false;
        private IntPtr handle;
        private Component component = new Component();

        public NetworkConnection(string remoteUNC, string username, string password) {
        ...
        private static string connectToRemote(string remoteUNC, string username, string password, bool promptUser = false)
        {
        ...
        public static string disconnectRemote(string remoteUNC)
        {
            ...
            int ret = WNetCancelConnection(remoteUNC, true);
            if (ret == NO_ERROR) return null;
            return getErrorForNumber(ret);
        }
